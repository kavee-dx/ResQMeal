...
export default function CreateDonationScreen() {
  ...
  const [donationType, setDonationType] = useState<'normal' | 'urgent'>('normal');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Donation submitted', 'Your food donation has been recorded.', [
  ...
  return (
    ...
    >
      <ScrollView contentContainerClassName="px-5 pb-10 pt-6" keyboardShouldPersistTaps="handled">
        <Text className="mb-1 text-2xl font-extrabold text-slate-900">New Food Donation</Text>
        <Text className="mb-6 text-sm text-slate-500">
          Share your surplus food details below — it only takes a minute.
        </Text>
              ...
              >
                <Text
                  className={`text-sm font-semibold ${
                    donationType === type ? 'text-white' : 'text-slate-600'
                  }`}
                >
                  {type === 'normal' ? 'Normal' : '⚡ Urgent'}
                </Text>
              </Pressable>
            ))}
          </View>
        ...
        <SectionCard title="Food Information">
          ...
          <View className="flex-row gap-3">
            ...
            <View className="flex-1">
              <FormInput
                ...
                onChangeText={setField('numberOfPortions')}
                placeholder="30"
                keyboardType="numeric"
          ...
          <FormInput
            ...
            onChangeText={setField('preparationTime')}
        ...
        <SectionCard title="Food Safety Information">
              ...
              >
                <Text
                  className={`text-xs font-semibold ${
                    values.storageCondition === option ? 'text-emerald-700' : 'text-slate-500'
                  }`}
                >
                  {option}
                </Text>
          ...
          <FormInput
            ...
            onChangeText={setField('packagingCondition')}
        ...
        <SectionCard title="Pickup Information">
          ...
          <FormInput
            ...
            onChangeText={setField('pickupDistrict')}
          ...
          <View className="flex-row gap-3">
            <View className="flex-1">
              <FormInput
                ...
                onChangeText={setField('pickupWindowStart')}
                placeholder="5:30 PM"
              />
            </View>
            <View className="flex-1">
              <FormInput
                ...
                onChangeText={setField('pickupWindowEnd')}
                placeholder="6:00 PM"
              />
            </View>
          </View>
        ...
        >
          {submitting ? (
            ...
            <Text className="text-base font-bold text-white">Submit Donation</Text>
          )}
        </Pressable>
      </ScrollView>
    </KeyboardAvoidingView>
